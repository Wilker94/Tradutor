...
def telas (tela):
    ...
    def topo ():
        ...
        caracteres_faltantes = tk.Label(frame_topo, text="Caracteres restantes:", width=60)
        ...
        #Botão Baixar Audio
        config_button = tk.Button(frame_topo, text="CONFIG", height=1, command=config_audio)
        config_button.grid(row=0, column=4, padx=(280,0), pady=2, sticky=tk.E)
    ...
    def api_usuario ():
        ...
        def botoes ():
            ...
            #Botão Traduzir
            translate_button = tk.Button(frame_campos, text="Traduzir", width=32, command=lambda: traduz_texto(texto_traducao_input, checkbox_portugues, translate_portugues_label, translate_portugues_text, 
            ...
            #Botão Configuração
            #translate_button = tk.Button(tela, text="Config", command=voz)
            #translate_button.grid(row=8, column=5, padx=10, pady=(20, 0), sticky=tk.W)
    ...
    def idiomas_traduzidos():
        ...
        frame_canvas.grid(row=2, column=0, columnspan=6, padx=10, pady=10, sticky='nsew')
 
        
        canvas = tk.Canvas(frame_canvas, height=600)
